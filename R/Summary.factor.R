...
#' ..
#' 
#' @param x a \link[base]{factor} object
#' 
...
#' 
#' @returns 
#' Function [Summary.factor()] 
#' overwrites function \link[base]{Summary.factor} and 
#' returns a \link[base]{factor}.
#' 
#' @examples
...
#' @export
Summary.factor <- function(x, ..., na.rm = FALSE) {
